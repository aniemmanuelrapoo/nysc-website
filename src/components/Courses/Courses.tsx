        ...
        <Row>
          <Col lg={6} md={12} sm={12}>
            <Row>
              ...
              <Col lg={6} md={6} sm={12} className='p-2'>
                <h5 className='service__name text-start'>NYSC Rules And Regulation</h5>
                <p className='service__discription'>All You Should Know About NYSC And How Not To Get Into Trouble During Your Service Yearr</p>
              ...
              <Col lg={6} md={6} sm={12} className='p-2'>
                <h5 className='service__name text-start'>NYSC Rules</h5>
                <p className='service__discription'>All You Should Know About NYSC And How Not To Get Into Trouble During Your Service Yearr</p>
                <a href="/home" rel='noreferrer noopener' className='float-start course__viewMore'>View Details</a>
              </Col>
            </Row>
