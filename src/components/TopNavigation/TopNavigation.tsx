  ...
  return (
    <>
      ...
      <Container>
        ...
        <Navbar.Brand className={`${navBarTitle} nav__sideOne`}><NavLink to="/" className={`${navBarTitle} nav__sideOne nav__sideLink`}> {navBarTitle === 'nav__titleScroll' ? <img src={ServiconLogo} alt='' className='nav__ServiconLogo' /> : <img src={NyscLogo} alt=''className='nav__NyscLogo' />} NYSC CAMP ACTIVITIES</NavLink></Navbar.Brand>
